...
(4, 'Transcrierea actelor de stare civilă', 'Transcriere certificate de naștere, căsătorie și alte acte de stare civilă în registrele românești.', 'Transcriere certificate de naștere, căsătorie și alte acte de stare civilă.', 'Servicii complete de transcriere a actelor de stare civilă (certificat de naștere, certificat de căsătorie, certificat de deces) din registrele străine în registrele românești. Necesar pentru obținerea actelor de identitate românești după cetățenie.', 'uploads/services/69a6b96fb2a6b_1772534127.jpg', '', '[\"Transcriere certificat naștere\", \"Transcriere certificat căsătorie\", \"Transcriere certificat deces\", \"Eliberare duplicate\", \"Rectificare date\"]', 5, 1, '2026-03-03 10:01:37', '2026-03-06 16:43:03'),
...
(180, 6, 'ru', 'Публикация приказа и Присяга', 'Помогаем от публикации приказа о предоставлении гражданства до принесения присяги верности Румынии.', 'Полная помощь от публикации приказа до принесения присяги.', 'Помогаем на всём финальном этапе получения гражданства: мониторинг публикации приказа в Официальном вестнике, запись на присягу в ANC Бухарест или консульства за рубежом, подготовка к церемонии и получение сертификата о гражданстве.', '[\"Мониторинг публикации приказа\", \"Запись на присягу ANC/Консульства\", \"Подготовка к церемонии\", \"Помощь при присяге\", \"Сертификат о гражданстве\"]', '2026-03-06 16:43:03', '2026-03-06 16:43:03'),
(181, 4, 'ro', 'Transcrierea actelor de stare civilă', 'Transcriere certificate de naștere, căsătorie și alte acte de stare civilă în registrele românești.', 'Transcriere certificate de naștere, căsătorie și alte acte de stare civilă.', 'Servicii complete de transcriere a actelor de stare civilă (certificat de naștere, certificat de căsătorie, certificat de deces) din registrele străine în registrele românești. Necesar pentru obținerea actelor de identitate românești după cetățenie.', '[\"Transcriere certificat naștere\", \"Transcriere certificat căsătorie\", \"Transcriere certificat deces\", \"Eliberare duplicate\", \"Rectificare date\"]', '2026-03-06 16:43:03', '2026-03-06 16:43:03'),
(182, 4, 'en', 'Civil Status Documents Transcription', 'Transcription of birth certificates, marriage certificates and other civil status documents into Romanian registers.', 'Transcription of birth, marriage and other civil status certificates.', 'Complete services for transcribing civil status documents (birth certificate, marriage certificate, death certificate) from foreign registers into Romanian registers. Required for obtaining Romanian identity documents after citizenship.', '[\"Birth certificate transcription\", \"Marriage certificate transcription\", \"Death certificate transcription\", \"Duplicate issuance\", \"Data correction\"]', '2026-03-06 16:43:03', '2026-03-06 16:43:03'),
(183, 4, 'ru', 'Транскрипция актов гражданского состояния', 'Транскрипция свидетельств о рождении, браке и других актов гражданского состояния в румынские реестры.', 'Транскрипция свидетельств о рождении, браке и других актов.', 'Полный комплекс услуг по транскрипции актов гражданского состояния (свидетельство о рождении, браке, смерти) из иностранных реестров в румынские. Необходимо для получения румынских документов после гражданства.', '[\"Транскрипция свидетельства о рождении\", \"Транскрипция свидетельства о браке\", \"Транскрипция свидетельства о смерти\", \"Выдача дубликатов\", \"Исправление данных\"]', '2026-03-06 16:43:03', '2026-03-06 16:43:03'),
...
(192, 16, 'ru', 'Транспорт', 'Перевозка людей и посылок между Молдовой и Румынией. Регулярные еженедельные рейсы по доступным ценам.', 'Перевозка людей и посылок между Молдовой и Румынией.', 'Перевозка людей и посылок между Молдовой, Румынией и диаспорой. Регулярные еженедельные рейсы по доступным ценам.', '[\"Регулярные рейсы\", \"Перевозка людей\", \"Посылки и документы\", \"Доступные цены\"]', '2026-03-06 16:43:04', '2026-03-06 16:43:04');
