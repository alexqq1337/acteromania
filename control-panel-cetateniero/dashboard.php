...
<div class="card mb-3">
    ...
    <div class="card-body">
        <div class="sections-grid">
            <a href="sections/hero.php" class="section-card">
            ...
            <a href="sections/about.php" class="section-card">
                <div class="section-card-icon">
            ...
            <a href="sections/services.php" class="section-card">
                <div class="section-card-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                </div>
                <h3>Servicii</h3>
            ...
            <a href="sections/process.php" class="section-card">
                <div class="section-card-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
                </div>
            ...
            <a href="sections/why-us.php" class="section-card">
                <div class="section-card-icon">
            ...
            <a href="sections/testimonials.php" class="section-card">
                <div class="section-card-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
                </div>
                <h3>Recenzii</h3>
            ...
            <a href="sections/reviews.php" class="section-card<?php echo $stats['reviews_pending'] > 0 ? ' has-badge' : ''; ?>">
            ...
            <a href="sections/reviews.php?filter=pending" class="section-card section-card-pending">
                <?php if ($stats['reviews_pending'] > 0): ?>
                <span class="section-badge"><?php echo $stats['reviews_pending']; ?></span>
                <?php endif; ?>
                <div class="section-card-icon">
            ...
            <a href="sections/faq.php" class="section-card">
                <div class="section-card-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
                </div>
                <h3>FAQ</h3>
            ...
            <a href="sections/contact.php" class="section-card">
                <div class="section-card-icon">
            ...
            <a href="media.php" class="section-card">
                <div class="section-card-icon">
